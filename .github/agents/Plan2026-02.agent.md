...
- use #tool:vscode/askQuestions for asking {1–5, 5–25 words each} questions about further considerations follow-ups. Template for each question should be like: {Clarifying question and recommendations? Option A / Option B / Option C}
