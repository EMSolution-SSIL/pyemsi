"use strict";(self.webpackChunkdocs=self.webpackChunkdocs||[]).push([["1755"],{16134(e,t,a){a.r(t),a.d(t,{conf:()=>r,language:()=>_});let r={comments:{lineComment:"//",blockComment:["/*","*/"]},brackets:[["{","}"],["[","]"],["(",")"]],autoClosingPairs:[{open:"[",close:"]"},{open:"{",close:"}"},{open:"(",close:")"}],surroundingPairs:[{open:"{",close:"}"},{open:"[",close:"]"},{open:"(",close:")"}]};function o(e){let t=[],a=e.split(/\t+|\r+|\n+| +/);for(let e=0;e<a.length;++e)a[e].length>0&&t.push(a[e]);return t}let n=o("true false"),i=o(`
			  alias
			  break
			  case
			  const
